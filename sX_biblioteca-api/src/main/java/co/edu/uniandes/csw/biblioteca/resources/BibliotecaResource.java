...
public class BibliotecaResource {
    ...
    private static final String EL_RECURSO = "El recurso /bibliotecas/";
    ...
    /**
     * Crea una nueva biblioteca con la informacion que se recibe en el cuerpo
    ...
    public BibliotecaDTO createBiblioteca(BibliotecaDTO biblioteca) throws BusinessLogicException {
        LOGGER.log(Level.INFO, "BibliotecaResource createBiblioteca: input: {0}", biblioteca);
        ...
        LOGGER.log(Level.INFO, "BibliotecaResource createBiblioteca: output: {0}", nuevoBibliotecaDTO);
     ...
     */
    @GET
    public List<BibliotecaDetailDTO> getBibliotecas() {
        ...
        LOGGER.log(Level.INFO, "BibliotecaResource getBibliotecas: output: {0}", listaBibliotecas);
    ...
    public BibliotecaDetailDTO getBiblioteca(@PathParam("bibliotecasId") Long bibliotecaId) {
        ...
        if (bibliotecaEntity == null) {
            throw new WebApplicationException(EL_RECURSO + bibliotecaId + NO_EXISTE, 404);
        }
    ...
    public BibliotecaDTO actualizarBiblioteca(@PathParam("bibliotecasId") Long bibliotecasId, BibliotecaDTO biblioteca) {
        LOGGER.log(Level.INFO, "BiblitoecaResource updateBiblioteca: input: id:{0} , biblioteca: {1}", new Object[]{bibliotecasId, biblioteca});
        biblioteca.setId(bibliotecasId);
        if (bibliotecaLogic.getBiblioteca(bibliotecasId) == null) {
            throw new WebApplicationException(EL_RECURSO + bibliotecasId + NO_EXISTE, 404);
        }
        BibliotecaDetailDTO detailDTO = new BibliotecaDetailDTO(bibliotecaLogic.updateBiblioteca(bibliotecasId, biblioteca.toEntity()));
        LOGGER.log(Level.INFO, "BibliotecaResource updateBiblioteca: output: {0}", detailDTO);
        return detailDTO;
    }
