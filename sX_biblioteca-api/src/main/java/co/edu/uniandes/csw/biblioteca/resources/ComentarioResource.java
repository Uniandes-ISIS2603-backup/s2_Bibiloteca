...
public class ComentarioResource {
     ...
     * @return JSON {@link ComentarioDTO} - La reseña guardada con el atributo
     * id autogenerado.
     * @throws Exception {@link BusinessLogicExceptionMapper} - Error de lógica
     * que se genera cuando ya existe la reseña.
     */
    @POST
    public ComentarioDTO createComentario(@PathParam("librosId") Long libroId, ComentarioDTO comentario, @PathParam("usuariosId") Long usuarioId) throws BusinessLogicException {
        return new ComentarioDTO(comentarioLogic.createComentario(libroId, comentario.toEntity(), usuarioId));
    }
    ...
    public List<ComentarioDTO> getComentarios(@PathParam("librosId") Long libroId) {
        return listEntity2DTO(comentarioLogic.getComentariosPorLibro(libroId));
    ...
    public ComentarioDTO updateComentario(@PathParam("librosId") Long libroId, @PathParam("comentarioId") Long comentarioId, ComentarioDTO comentario) throws BusinessLogicException {
        ...
        return new ComentarioDTO(comentarioLogic.updateComentario(libroId, comentario.toEntity(), comentario.getUsuario().getId()));
