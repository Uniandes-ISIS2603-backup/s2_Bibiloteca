...
/**
 ...
 public SalaDTO getSalaBiblioteca (@PathParam("librosId") Long bibliotecaId, @PathParam("salaId") Long salaId){
     ...
     *
     * @param bibliotecaId El ID de la biblioteca en la cual se buscan las salas.
 ...
 {
     List<SalaDTO> listaDTO = listEntity2DTO(salaLogic.getSalasPorBiblioteca(bibliotecaId));
     return listaDTO;
 }
 ...
 */    
 ...
 public SalaDTO updateSala(@PathParam("bibliotecasId") Long bibliotecaId, @PathParam("salaId") Long salaId ,SalaDTO sala) throws BusinessLogicException  {
     ...
     SalaDTO salaDTO = new SalaDTO(salaLogic.updateSala(bibliotecaId, sala.toEntity()));
     return salaDTO;
  ...
  /**
     ...
     *
     * @param bibliotecaId El ID de la biblioteca de la cual se va a eliminar la sala.
