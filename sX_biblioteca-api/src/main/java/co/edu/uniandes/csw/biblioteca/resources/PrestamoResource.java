...
public class PrestamoResource {
    ...
    /**
     * Crea un prestamo con la informacion que se recibe en el cuerpo de la
     * petición y se regresa un objeto identico con un id auto-generado por la
     * base de datos.
     *
     * @param prestamo {@link PrestamoDTO} - El prestamo que se desea guardar.
    ...
    public PrestamoDTO createPrestamo(PrestamoDTO prestamo) throws BusinessLogicException {
        LOGGER.log(Level.INFO, "PrestamoResource createPrestamo: input: {0}", prestamo);
        ...
        LOGGER.log(Level.INFO, "PrestamoResource createPrestamo: output: {0}", nuevoPrestamoDTO);
     ...
     *
     * @return JSONArray {@link PrestamoDTO} - Los prestamos encontrados en la
    ...
    public List<PrestamoDTO> getPrestamos() {
        ...
        LOGGER.log(Level.INFO, "EditorialResource getReviews: output: {0}", listaDTOs);
        return listaDTOs;
    }
     ...
     *
     * @param prestamoId Identificador del prestamo que se esta buscando. Este
    ...
    public PrestamoDTO getPrestamo(@PathParam("prestamosId") Long prestamoId) {
        ...
        if (prestamoEntity == null) {
            throw new WebApplicationException(RUTA + prestamoId + NO_EXISTE, 404);
        }
        PrestamoDTO prestamoDTO = new PrestamoDTO(prestamoEntity);
        LOGGER.log(Level.INFO, "PrestamoResource getPrestamo: output: {0}", prestamoDTO);
        return prestamoDTO;
    }

    /**
     * Actualiza el prestamo con el id recibido en la URL con la informacion que
     * se recibe en el cuerpo de la petición.
     *
     * @param prestamoId Identificador del prestamo que se desea actualizar.
    ...
    @PUT
    @Path("{prestamosId: \\d+}")
    public PrestamoDTO actualizarPrestamo(@PathParam("prestamosId") Long prestamoId, PrestamoDTO prestamo) {
        LOGGER.log(Level.INFO, "PrestamoResource updatePrestamo: input: id:{0} , editorial: {1}", new Object[]{prestamoId, prestamo});
     ...
     *
     * @param prestamosId Identificador del prestamo que se desea borrar. Este
     * debe ser una cadena de dígitos.
     * @throws BusinessLogicException {@link BusinessLogicExceptionMapper} -
