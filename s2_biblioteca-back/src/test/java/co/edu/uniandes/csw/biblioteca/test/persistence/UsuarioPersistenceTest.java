...
public class UsuarioPersistenceTest {
    ...
    public void getUsuarioTest(){
        ...
        UsuarioEntity nuevaEntity = usuarioPersistence.find(entity.getId());
    ...
    public void getUsuariosTest()
    {
        ...
        for(UsuarioEntity i : lista)
        {
            boolean encontrado = false;
            for(UsuarioEntity j : data)
            {
    ...
    public void updateUsuarioTest()
    {
        UsuarioEntity entity = data.get(0);
        PodamFactory factory = new PodamFactoryImpl();
        UsuarioEntity nueva = factory.manufacturePojo(UsuarioEntity.class);
        
        nueva.setId(entity.getId());
        
        usuarioPersistence.update(nueva);
