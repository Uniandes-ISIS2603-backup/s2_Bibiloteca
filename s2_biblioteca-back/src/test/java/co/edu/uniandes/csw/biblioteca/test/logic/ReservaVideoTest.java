...
import co.edu.uniandes.csw.biblioteca.ejb.ReservaVideoLogic;
...
public class ReservaVideoTest {
     ...
     */
    @Inject
    private ReservaVideoLogic reservaVideoLogic;
    ...
    private void insertData() {
        ...
        for (int i = 0; i < 3; i++) 
        {
            ...
            if (i == 0)
            {
                reservasData.get(i).setVideo(entity);
                reservasData.get(i).setTipoRecurso("VIDEO");
            }
        }
    }

    /**
     * Prueba para desasociar una reserva existente de un VIDEO existente
     * @throws BusinessLogicException
     */
    @Test
    public void removeReservasTest() throws BusinessLogicException 
    {
        reservaVideoLogic.removeVideo(reservasData.get(0).getIdRecursoReservado());
        ReservaEntity response = reservaLogic.getReserva(reservasData.get(0).getId());
        Assert.assertNull(response.getVideo());
    }
